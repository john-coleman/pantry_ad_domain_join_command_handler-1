  ...
  module Daemon
    class PantryAdDomainJoinCommandHandler
      ...
      def handle_message(message)
        ...
        rename_cmd = "NETDOM RENAMECOMPUTER localhost /NewName:#{message['instance_name']} /Force & echo ERRORLEVEL: %ERRORLEVEL%"
        ...
        netdom_rename_cmd = "NETDOM RENAMECOMPUTER localhost /NewName:#{message['instance_name']} /UserD:EXAMPLE\\#{@ad_username} /PasswordD:\"#{@ad_password}\" /Force & echo ERRORLEVEL: %ERRORLEVEL%"
