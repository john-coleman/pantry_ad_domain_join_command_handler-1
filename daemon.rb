...
handler = Wonga::Daemon::PantryAdDomainJoinCommandHandler.new(Wonga::Daemon.config['ad']['domain'], Wonga::Daemon.config['ad']['username'], Wonga::Daemon.config['ad']['password'], Wonga::Daemon.publisher, Wonga::Daemon.logger)
